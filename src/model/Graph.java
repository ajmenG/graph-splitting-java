...
public class Graph {
    ...
    public void setMinCount(double accuracy) {
        if (accuracy < 0.0 || accuracy > 1.0 || this.partitions <= 0) {
            throw new IllegalArgumentException("Accuracy must be between 0.0 and 1.0 and partitions must be greater than 0.");
        } else {
            ...
            System.out.println("Min count set to: " + this.minCount + " (average: " + avgSize + ", accuracy: " + accuracy + ")");
        }
    }
    ...
    public void setMaxCount(double accuracy) {
        if (accuracy < 0.0 || accuracy > 1.0 || this.partitions <= 0) {
            ...
            System.out.println("Max count set to: " + this.maxCount + " (average: " + avgSize + ", accuracy: " + accuracy + ")");
        }
    }
